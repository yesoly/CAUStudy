...
public class HomeStudy_SingerViewer extends LinearLayout {
    TextView title;
    TextView period;
    TextView time;
    ...
    public HomeStudy_SingerViewer(Context context) {
        super(context);
        init(context);
    }

    public HomeStudy_SingerViewer(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
