...
public class PostViewActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child(study_key).child("assignment_list").child(title_prev).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
