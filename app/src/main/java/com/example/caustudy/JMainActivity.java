...
public class JMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void set_listview(){
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(JMainActivity.this);
        mPostRecyclerView.setLayoutManager(linearLayoutManager);

        studyRef.child(study_key).child("notice_list").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
